{
   ...
   TArrow *arrow1 = new TArrow(1.084000,57.565841,1.084000,16.868750,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(3.644000,728.394447,3.644000,213.444351,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(7.100000,16192.469312,7.100000,4744.944336,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(8.380000,55213.429566,8.380000,16179.413086,0.02,">");
   arrow4->Draw();
   c1->Update();
