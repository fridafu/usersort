{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.836000,10.684000,50,0.037579,173300.000000);
   ...
   float Bnerr[1]={0.001};
   float rho_Bn[1]={17330.000000};
   float rho_Bnerr[1]={2412.000000};
   int i = 0;
   float a0 =  -0.8360;
   float a1 =   0.1280;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    8.547,8.665e+04,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(1.084000,58.169251,1.084000,17.410595,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(3.644000,688.013901,3.644000,205.928925,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(7.100000,13963.407273,7.100000,4179.376953,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(8.380000,46033.505223,8.380000,13778.253906,0.02,">");
   arrow4->Draw();
   c1->Update();
