{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.836000,10.684000,50,0.032467,215100.000000);
   ...
   float Bnerr[1]={0.001};
   float rho_Bn[1]={21510.000000};
   float rho_Bnerr[1]={3365.000000};
   int i = 0;
   float a0 =  -0.8360;
   float a1 =   0.1280;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    8.547,1.076e+05,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(1.084000,55.643638,1.084000,16.298643,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(3.644000,732.152592,3.644000,214.455673,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(7.100000,17158.410578,7.100000,5025.890137,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(8.380000,59662.372468,8.380000,17475.775391,0.02,">");
   arrow4->Draw();
   c1->Update();
